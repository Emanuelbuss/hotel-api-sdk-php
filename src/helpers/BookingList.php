 ...
 * @property boolean $includeCancelled The parameter is used to get all bookings including cancelled bookings
 *     or excluding cancelled bookings
 * @property string $filterType The parameter is used to identify if the bookings list is by check-in date
 *     or by booking creation date.
 * @property string $status The parameter is used to get all bookings, including or excluding cancelled bookings.
 *     Values:
