...
abstract class ApiRequest implements ApiCallTypes
{
     ...
     */
    protected Http $baseUri;

    private ApiHelper $dataRQ;
     ...
     */
    public function __construct(ApiUri $baseUri, string $operation)
    {
     ...
     */
    protected function setDataRequest(ApiHelper $dataRQ): void
    {
        $this->dataRQ = $dataRQ;
    }
