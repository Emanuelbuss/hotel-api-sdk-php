 ...
 * @property int $paymentType Payment type.
 *     Values:
 *         AT_WEB(Merchant model),
 *         AT_HOTEL(Pay at hotel model) and
 *         BOTH(Both(Default value))
 * @property int $hotelPackage It is used to include or exclude hotel packages.
 *     Those are packages created by us that include another product (like massage, a ticket, etc.)
 *     together with the hotel.Values:
 *         YES(To retrieve only hotel packages),
 *         NO(To retrieve only non hotel packages) and
